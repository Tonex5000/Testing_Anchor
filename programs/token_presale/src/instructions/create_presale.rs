...
pub fn create_presale(
    ...
    presale_info.sol_token_mint_address = sol_token_mint_address;
    presale_info.usdt_token_mint_address = usdt_token_mint_address;
    presale_info.usdc_token_mint_address = usdc_token_mint_address;
