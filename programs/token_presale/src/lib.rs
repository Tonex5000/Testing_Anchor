...
// declare_id!("6f4bDbRHKBTeFVxSsPjJ8SNipRhKZjdwVi2RE5dyseyP");
declare_id!("3pRfgQcdeCh3keQKZYPU4Jny9MmMxh3FawBhpasR7JCA");
#[program]
pub mod token_presale {
    ...
    pub fn buy_token_stable(
        ...
        return buy_token_stable::buy_token_stable(
            ctx,
            quote_amount,
            identifier
        );
